...
export class QuotationController {
  ...
  async findQuotation(@Req() req: RequestWithUser, @Param('id') id: string) {
  ...
  async deleteQuotation(@Req() req: RequestWithUser, @Param('id') id: string) {
  ...
  async search(
    @Req() req: RequestWithUser,
    @Body() options: QuotationSearchOptions,
  ): Promise<Pagination> {
