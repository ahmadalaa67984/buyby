...
export class UsersController {
  ...
  async myActiveUsers(
    ...
    @Body() options: UserSearchOptions,
  ): Promise<Pagination> {
  ...
  async updateCustomerPromotional(
    @Req() req: RequestWithUser,
    @Param('id') id: string,
    @Body() dto: UpdateCustomerPromotionalDto,
  ): Promise<User> {
  ...
  updateUserDeviceToken(@Param('id') id: string, @Body() dto: UpdateUserDeviceTokenDto) {
  ...
  @Roles(...RoleGroups.BUSSINESS)
  @ApiOperation({
    summary: 'Create a profile for users under resturant and merchant',
  })
  ...
  @Post('/business-customers-users')
  @UseGuards(JwtAuthGuard, RoleGuard)
  @ApiOperation({ summary: 'Get all business and customer users' })
  async getBusinessCustomerUsers(@Body() options: UserSearchOptions) {
    return await this.usersService.getBusinessCustomerUser(options);
  }

  @Post('/business')
  @UseGuards(JwtAuthGuard, RoleGuard)
  @ApiOperation({ summary: 'Get all business  users' })
  async getBusinessUsers(@Body() options: UserSearchOptions) {
    return await this.usersService.getBusinessUser(options);
  }
