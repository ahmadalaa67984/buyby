...
export class User extends BaseEntity {
  ...
  @Prop({
    type: String,
    default: SubscriptionTypeEnum.CASHIER,
  ...
  @Prop({
    type: String,
    default: PricingEnum.QUARTERLY,
    enum: Object.values(PricingEnum),
  })
  pricing: PricingEnum;
  ...
  @Prop({ type: String, required: false })
  paidSubPricing?: string;

  @Prop({
    type: String,
    enum: Object.values(PaymentOperationEnum),
  })
  paymentOperationType?: PaymentOperationEnum;

  @Prop({
    type: String,
    enum: Object.values(PaymentOperationStatusEnum),
  })
  paymentOperationStatus?: PaymentOperationStatusEnum;

  @Prop({ type: Number, required: false })
  paidExtraUser: number;
