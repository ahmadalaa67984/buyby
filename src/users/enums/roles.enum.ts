...
export const RoleGroups = {
  ...
  BUSSINESS_CASHIER_CHEF: [
    RolesEnum.RESTURANT,
    RolesEnum.MERCHANT,
    RolesEnum.CASHIER,
    RolesEnum.CHEF,
  ],
  BUSSINESS_CASHIER_INVENTORY: [
    RolesEnum.RESTURANT,
    RolesEnum.MERCHANT,
    RolesEnum.CASHIER,
    RolesEnum.INVENTORYMAN,
  ],
  BUSSINESS_CASHIER_CUSTOMER: [
    RolesEnum.RESTURANT,
    RolesEnum.MERCHANT,
    RolesEnum.CASHIER,
    RolesEnum.CUSTOMER,
  ],
  BUSSINESS_CASHIER_WAITER_CUSTOMER: [
    RolesEnum.RESTURANT,
    RolesEnum.MERCHANT,
    RolesEnum.CASHIER,
    RolesEnum.CUSTOMER,
