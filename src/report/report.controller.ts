...
export class ReportController {
  ...
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles(...RoleGroups.BUSSINESS)
  addTransactionReport(@Req() req: RequestWithUser, @Body() options: DateFilter): Promise<any[]> {
  ...
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles(...RoleGroups.BUSSINESS)
  auditTransactionReport(@Req() req: RequestWithUser, @Body() options: DateFilter): Promise<any[]> {
  ...
  releaseTransactionReport(
    ...
    return this.reportService.releaseTransactionReport(options, req.user.entityId, res);
  }
  ...
  reverseTransactionReport(
    ...
    return this.reportService.reverseTransactionReport(options, req.user.entityId);
  }
  ...
  shrinkageTransactionReport(
    ...
    return this.reportService.shrinkageTransactionReport(options, req.user.entityId);
  }
  ...
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles(...RoleGroups.BUSSINESS)
  wasteTransactionReport(@Req() req: RequestWithUser, @Body() options: DateFilter): Promise<any[]> {
  ...
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles(...RoleGroups.BUSSINESS)
  deferredPayableReport(@Req() req: RequestWithUser, @Body() options: DateFilter): Promise<any[]> {
  ...
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles(...RoleGroups.BUSSINESS)
  payable(@Req() req: RequestWithUser, @Body() options: DateFilter): Promise<any[]> {
    return this.reportService.payable(options, req.user._id);
  }

  @Post('me/payable-report')
  @ApiOperation({ summary: 'payable report' })
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles(...RoleGroups.BUSSINESS)
  payableReport(@Req() req: RequestWithUser, @Res() res: Response, @Body() dto: ReportDto) {
    return this.reportService.payableReport(dto, res, req.user._id);
  }

  @Post('me/receivable-report')
  @ApiOperation({ summary: 'receivable report' })
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles(...RoleGroups.BUSSINESS)
  receivableReport(@Req() req: RequestWithUser, @Res() res: Response, @Body() dto: ReportDto) {
    return this.reportService.receivableReport(dto, res, req.user._id);
  }
  ...
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles(...RoleGroups.BUSSINESS)
  receivable(@Req() req: RequestWithUser, @Body() options: DateFilter): Promise<any[]> {
    return this.reportService.receivable(options, req.user._id);
  }
  ...
  @ApiOperation({
    summary: 'Customer Count for section / Total Customer Count in store',
  })
  async customerCountInSection(
    @Req() req: RequestWithUser,
    @Body() dto: ReportDto,
    @Res() res: Response,
  ) {
  ...
  @UseGuards(JwtAuthGuard)
  @ApiOperation({
    summary: 'Customer Count for department / Total Customer Count in store',
  })
  async customeCountInDepartment(
    @Req() req: RequestWithUser,
    @Body() dto: ReportDto,
    @Res() res: Response,
  ) {
  ...
  async recievablesAndDeferredrecievablesLists(
    @Req() req: RequestWithUser,
    @Body() dto: ReportDto,
  ) {
  ...
  @Post('me/logs-list')
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles(...RoleGroups.ADMINISTRATION)
  ...
  async topItems(@Req() req: RequestWithUser, @Body() dto: ReportDto) {
    return await this.reportService.topItemsSold(req, dto, req.user.entityId);
  }

  @Post('top-items-sold')
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles(...RoleGroups.ADMINISTRATION)
  @ApiOperation({ summary: 'Top items Sold - super Admin' })
  async sysTopItems(@Req() req: RequestWithUser, @Body() dto: ReportDto) {
    return await this.reportService.topItemsSold(req, dto);
  }

  @Post('me/monthly-revenues')
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles(...RoleGroups.ADMINISTRATION)
  @ApiOperation({ summary: ' Revenues grouped by month - SA' })
  async monthlyRevenues(@Body() dto: YearDto) {
    return await this.reportService.monthlyRevenue(dto);
  }

  @Post('me/monthly-created-restaurants')
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles(...RoleGroups.ADMINISTRATION)
  @ApiOperation({ summary: 'count restaurants create in month - SA' })
  async countMonthlyCreatedRes(@Body() dto: YearDto) {
    return await this.reportService.countMonthlyCreatedRes(dto);
  }

  @Post('me/monthly-created-stores')
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles(...RoleGroups.ADMINISTRATION)
  @ApiOperation({ summary: 'count stores create in month - SA' })
  async countMonthlyCreatedStores(@Body() dto: YearDto) {
    return await this.reportService.countMonthlyCreatedStores(dto);
  }

  @Post('me/monthly-created-customers')
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles(...RoleGroups.ADMINISTRATION)
  @ApiOperation({ summary: 'count stores create in month - SA' })
  async countMonthlyCreatedCustomers(@Body() dto: YearDto) {
    return await this.reportService.countMonthlyCreatedCustomers(dto);
  }
}
