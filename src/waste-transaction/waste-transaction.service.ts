...
import {
  WasteTransaction,
  WasteTransactionDoc,
} from './entities/waste-transaction.entity';
...
export class WasteTransactionService extends BaseService<WasteTransactionDoc> {
  ...
  async createWasteTransactions(
    ...
    await session.withTransaction(async (): Promise<any> => {
              ...
              },
              {
                ...
                $set: {
                  'batches.$.qtyRemaining':
                    selectedBatch.batches[0].qtyRemaining - item.wasteQty,
                },
              },
      ...
      stockitemWasted = await this.m.create(
        [
          {
